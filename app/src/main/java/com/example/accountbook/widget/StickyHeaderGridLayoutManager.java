...
import static com.example.accountbook.widget.StickyHeaderGridAdapter.TYPE_HEADER;
import static com.example.accountbook.widget.StickyHeaderGridAdapter.TYPE_ITEM;
...
public class StickyHeaderGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
   ...
   /**
    * Returns the current {@link SpanSizeLookup} used by the StickyHeaderGridLayoutManager.
    *
    * @return The current {@link SpanSizeLookup} used by the StickyHeaderGridLayoutManager.
    */
   ...
   /**
    * Returns the current {@link HeaderStateChangeListener} used by the StickyHeaderGridLayoutManager.
    *
    * @return The current {@link HeaderStateChangeListener} used by the StickyHeaderGridLayoutManager.
    */
    ...
    *
    * @param listener {@link HeaderStateChangeListener} instance to be used to receive header
    *                 state changes
    */
    ...
    *
    * @see StickyHeaderGridLayoutManager#setSpanSizeLookup(SpanSizeLookup)
    */
