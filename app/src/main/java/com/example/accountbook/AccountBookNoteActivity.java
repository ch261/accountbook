 ...
 * 记账本 --- 记一笔
 */
public class AccountBookNoteActivity extends BaseActivity {

    public @BindView(R.id.tb_note_income)
    TextView incomeTv;
    public @BindView(R.id.tb_note_outcome)
    TextView outcomeTv;
    public @BindView(R.id.tb_note_remark)
    ImageView remarkTv;
    public @BindView(R.id.tb_note_money)
    TextView moneyTv;
    public @BindView(R.id.tb_note_date)
    TextView dateTv;
    public @BindView(R.id.tb_note_cash)
    TextView cashTv;
    public @BindView(R.id.viewpager_item)
    ViewPager viewpagerItem;
    public @BindView(R.id.layout_icon)
