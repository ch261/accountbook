...
import static com.example.accountbook.utils.DateUtils.FORMAT_D;
...
import static com.example.accountbook.utils.DateUtils.FORMAT_YMD;
...
public class BillAddActivity extends BaseMVPActivity<BillContract.Presenter>
    ...
    public void doCommit() {
        ...
        if ((num + dotNum).equals("0.00")) {
            Toast.makeText(this, "还没输入金额", Toast.LENGTH_SHORT).show();
            return;
        }
